 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TicketDetails" type="{http://bbps.org/schema}TicketDetails" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    protected List<TicketDetails> ticketDetails;
    ...
    public List<TicketDetails> getTicketDetails() {
        if (ticketDetails == null) {
            ticketDetails = new ArrayList<TicketDetails>();
        }
